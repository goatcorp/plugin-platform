		...
		jsonData := `[
			{
				...
				"updated": "2022-08-19 03:47:30.643",
				"name": "profiles",
				"system": true,
				"schema": [
					{
			...
			},
			{
				...
				"updated": "2022-08-22 23:43:50.141",
				"name": "presets",
				"system": false,
				"schema": [
					{
			...
			},
			{
				...
				"updated": "2022-08-20 03:57:00.466",
				"name": "preset_data",
				"system": false,
				"schema": [
					{
			...
			},
			{
				...
				"updated": "2022-08-20 00:54:33.006",
				"name": "preset_stats",
				"system": false,
				"schema": [
					{
			...
			},
			{
				...
				"updated": "2022-08-22 00:56:07.916",
			...
			},
			{
				...
				"updated": "2022-08-20 20:40:44.844",
				"name": "tags",
				"system": false,
				"schema": [
					{
			...
			},
			{
				...
				"updated": "2022-08-20 17:12:54.181",
				"name": "preset_tags",
				"system": false,
				"schema": [
					{
				...
				"updateRule": "@request.user.id = preset.author.userId",
				"deleteRule": "@request.user.id = preset.author.userId"
			},
			{
				"id": "Go3oFqSnlKsvTSB",
				"created": "2022-08-20 19:00:56.707",
				"updated": "2022-08-20 19:20:40.047",
				"name": "user_settings",
				"system": false,
				"schema": [
					{
			...
			},
			{
				...
				"updated": "2022-08-23 02:20:02.684",
				"name": "plugins",
				"system": false,
				"schema": [
					{
